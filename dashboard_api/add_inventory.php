...
switch ($method) {
    case "POST":
        ...
        if ($check_stmt->num_rows > 0) {
            ...
            $sql = "INSERT INTO Inventory (ItemName, Quantity, CostPrice, SellingPrice,DateAdded,UserID) VALUES (?,?,?,?,?,?)";
            ...
            $stmt->bind_param("siiisi", $item_name, $item_quantity, $item_cost, $item_selling,$current_date,$user_id);
